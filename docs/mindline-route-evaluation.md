...
**Buy Set 2** — carried forward as the campaign package **DBP C1** (see
`docs/DBP-C1-mindline.pptx`, generated by `tools/build_dbp_c1_deck.js` from
`tools/dbp_c1_dco.py`, which also derives its geofence zones and dayparts).
